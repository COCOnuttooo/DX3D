#include "Framework.h"
#include "ReverseSphere.h"


ReverseSphere::ReverseSphere(float radius, UINT sliceCount, UINT stackCount)
	:radius(radius), sliceCount(sliceCount), stackCount(stackCount), GameObject(L"01_Texture")
{
	CreateMesh();
}

ReverseSphere::~ReverseSphere()
{
}



void ReverseSphere::CreateMesh()
{
