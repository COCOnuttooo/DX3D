#include "Framework.h"
#include "SolarBackgroundQuad.h"



SolarBackgroundQuad::SolarBackgroundQuad(Vector2 size)
...
SolarBackgroundQuad::~SolarBackgroundQuad()
{
	
}

void SolarBackgroundQuad::Render()
{
	GameObject::Render();

}

void SolarBackgroundQuad::CreateMesh()
{
	float L = -size.x * 0.5f;
	float R = +size.x * 0.5f;
	float B = -size.y * 0.5f;
