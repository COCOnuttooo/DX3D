...
void TerrainEditor::ComputePicking()
{
	...
	rayBuffer->data.plygonCount = polygonCount;
	rayBuffer->SetCSBuffer(0);
	//structuredBuffer->Copy(&output, sizeof(output));
	//for (auto& outputdesc : output)
	//{
	//	if (outputdesc.isPicked)
	//	{
	//		pickedPos = ray.origin + ray.direction * outputdesc.distance;
	//	}
	//}
}
