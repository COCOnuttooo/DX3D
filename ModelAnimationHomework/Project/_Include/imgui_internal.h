...
// (since IMGUI_VERSION_NUM >= 18729: IMGUI_DEBUG_LOG was reworked into IMGUI_DEBUG_PRINTF (and removed frameIndex from it). If you were using a #define IMGUI_DEBUG_LOG please rename)
